  ...
  return (
    <main className="flex-1 bg-ivory">
      <div className="mx-auto max-w-3xl px-4 py-16 md:px-8 md:py-24">
        ...
        <h1 className="heading-display mt-3 text-3xl text-foreground md:text-4xl">
          {t("title")}
        </h1>
        ...
        <div className="mt-14 space-y-12">
          {TODO_BLOCKS.map((k) => (
            <section key={k}>
              ...
              <ul className="mt-4 space-y-1.5 text-sm font-light text-secondary">
        ...
        <p className="mt-16 border-t border-sand pt-6 text-xs font-light text-muted">
          {t("lastUpdate")}
        </p>
      </div>
    </main>
